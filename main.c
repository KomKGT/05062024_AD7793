...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  KGT_AD7793_Reset();
  if(KGT_AD7793_Init() == 1)
  {
	  UART_SEND_TXT(&huart1, "AD7793 OK", 1);
  }
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  ui32_Data = KGT_AD7793_Read_Single_Conversion_Data_reg();
	  UART_SEND_TXT(&huart1, "Data : 0x", 0);
	  UART_SEND_HEX(&huart1, ui32_Data, 1);
  }
  /* USER CODE END 3 */
}
